        ...
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Process Test</h3>
      ...
      <section id="benefits" className="py-20 container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="p-8 shadow-soft hover:shadow-medium transition-all">
            ...
            <h3 className="text-2xl font-semibold mb-3">Unmatched Speed</h3>
          ...
          <Card className="p-8 shadow-soft hover:shadow-medium transition-all">
            ...
            <h3 className="text-2xl font-semibold mb-3">Superior Accuracy</h3>
            <p className="text-muted-foreground">
          ...
          <Card className="p-8 shadow-soft hover:shadow-medium transition-all">
            ...
            <h3 className="text-2xl font-semibold mb-3">Lower Costs</h3>
            <p className="text-muted-foreground">
